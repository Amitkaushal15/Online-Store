...
<a class="btn-primary btn-sucess" id="btnsucess" href="product.php?action=sucess" width="10%">Confirm</a>
<?php		
...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			...
			<div class="cart-action"><input type="text" class="product-quantity" name="quantity" value="1" size="2" /><input type="submit" value="Add to Cart" class="btnAddAction btn btn-primary btn-sucess" /></div>
			</div>
			</form>
		</div>
	<?php
